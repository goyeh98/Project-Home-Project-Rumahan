...
var possibleInput = {
  ...
  help: function () {
    ...
    responseText('Something like &quot;Goy, please show me Yoga&rsquo; best work&quot;');
    responseText('Did you find a bug or problem? Tweet me @Goyeh90');
    commandReset(0);
    return;
  },
  'best work': function () {
  ...
  project: function () {
    responseText('You have a project?');
    responseText('What kind of project?');
    responseText('Please type contact to discuss your project');
    commandReset(2);
    return;
  },
  experience: function () {
  ...
  interests: function () {
    responseText('Yoga loves:');
    responseText('Always learn Coding');
    responseText('Badminton time');
    responseText('Going out with friends');
    responseText('Working out');
    commandReset(5);
    return;
  ...
  vision: function () {
    ...
    responseText('Get great at Frontend Developer');
    responseText('All framework');
    responseText('And learn Backend ');
    commandReset(6);
    return;
  },
  contact: function () {
    responseText("email: <a href='mailto:yogadwinugraha@goyehid.com?Subject=Hello%20Yoga' target='_top'>yogadwinugraha@goyehid.com</a>");
    responseText("Twitter: <a href='https://twitter.com/goyeh90' target='_blank'>@Goyeh90</a>");
    responseText("Linkedin: <a href='https://www.linkedin.com/in/yogadwinugraha/' target='_blank'>Yoga Dwi Nugraha</a>");
    commandReset(7);
    return;
  },
  commands: function () {
    responseText('This is a list of commands Goy knows:');
    responseText('help, project, vision, interests, contact, rick roll');
    commandReset(8);
    return;
  },
  'rick roll': function () {
